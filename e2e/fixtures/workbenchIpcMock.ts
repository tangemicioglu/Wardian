  ...
  await page.addInitScript(
    ({
      ...
      const defaults: Record<string, unknown> = {
        ...
        list_automations: [],
        list_scheduled_runs: [],
        load_automation_library: { folders: [], rootAutomationIds: [] },
        // Both return a page, never a bare array; see src/test/pageFixtures.ts.
        automation_list_blueprints: { blueprints: [], truncated: false, next_offset: null },
        automation_list_runs: { runs: [], truncated: false, next_offset: null },
        schedule_list: [],
