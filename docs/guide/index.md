...
## Inspect and Ship Changes

- [Explorer](./explorer.md): browse the selected agent workspace or Wardian home.
- [Source Control](./source-control.md): stage, diff, commit, sync, and manage agent worktrees.
