...
`automation list`, `automation validate`, `automation parse`, `automation normalize`, `automation node-types`, `automation runs`, `automation run-show`, `automation replay`, `library`, `conversation list`, `conversation show`, `team`, and `watchlist` can run from disk without the desktop app.
