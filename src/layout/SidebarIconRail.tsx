    ...
    <aside data-testid="sidebar-icon-rail" className="w-[var(--sidebar-primary-width)] h-full bg-[var(--color-wardian-sidebar-primary)] border-r border-wardian-border flex flex-col items-center py-4 gap-3 z-30">
      ...
      <div className="mt-auto flex flex-col gap-3">
        ...
        <button
          ...
          aria-label={updateAvailable ? "Application Settings (update available)" : "Application Settings"}
        ...
        >
          ...
          {updateAvailable && (
            <span
              ...
              className="absolute right-1 top-1 h-2.5 w-2.5 rounded-full border-2 border-[var(--color-wardian-sidebar-primary)] bg-[var(--color-wardian-accent)]"
              data-testid="sidebar-tab-settings-update-badge"
              role="status"
            />
          )}
