...
export function AutomationMonitor({ onOpenRun, onEditSchedule }: AutomationMonitorProps) {
  ...
  return (
    ...
    >
      <div
        data-testid="automation-monitor-stats"
        className="automation-monitor__stats grid shrink-0 gap-2 rounded border border-wardian-border bg-[var(--color-wardian-card)] p-2"
      >
      ...
      <section className="flex min-h-0 flex-1 flex-col overflow-hidden rounded border border-wardian-border bg-[var(--color-wardian-bg)]">
        ...
        <div
          ...
          data-testid="automation-history-scroll"
          role="region"
        ...
        >
          ...
          {!hasVisibleActivity ? (
            <div className="select-text rounded border border-dashed border-wardian-border p-4 text-center text-xs text-muted">
              No automation activity in this view.
            </div>
          ) : null}
        </div>
      </section>
...
function ActivitySection({
  ...
  schedulesById: Map<string, AutomationSchedule>;
  ...
  return (
    <section className="mb-4 last:mb-0">
      ...
      <div
        data-testid={section === 'history' ? 'automation-history-card-list' : undefined}
        className={section === 'history' ? 'select-text' : 'automation-monitor__activity-grid grid select-text gap-2'}
      >
...
function VirtualHistoryRows({
  ...
  return (
    <div
      ref={listRef}
      data-testid="automation-history-virtual-list"
