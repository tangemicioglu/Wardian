...
import type { AutomationAssignments } from '../../../types/automation';

export interface AutomationAssignmentItem {
  key: string;
  role: string;
  targetLabel: string;
  detailLabel: string;
...
export function automationAssignmentItems(
  assignments: AutomationAssignments | undefined,
  bindings: Record<string, string> | undefined,
  provider: string | null | undefined,
  labels: Record<string, string>,
): AutomationAssignmentItem[] {
