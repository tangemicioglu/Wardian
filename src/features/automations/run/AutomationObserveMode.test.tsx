...
import { AutomationObserveMode } from './AutomationObserveMode';
...
const state: RunState = {
  run_id: 'run-1',
  blueprint_id: 'automation-1',
  status: 'completed',
  nodes: {},
};

const events: RunEvent[] = [
  { seq: 0, ts: '2026-06-04T16:08:09.000Z', kind: 'run_started', blueprint_id: 'automation-1', schema: 2, trigger: {} },
  { seq: 1, ts: '2026-06-04T16:08:10.000Z', kind: 'run_completed' },
];

describe('AutomationObserveMode', () => {
  beforeEach(() => {
  ...
  it('unmounts timeline content when the events panel is minimized', () => {
    render(<AutomationObserveMode theme="light" />);
