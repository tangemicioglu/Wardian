...
interface AutomationObserveModeProps {
  theme: 'dark' | 'light' | 'system';
}

export function AutomationObserveMode({ theme }: AutomationObserveModeProps) {
  ...
  return (
    <div data-testid="automations-observe-mode" className="grid h-full min-h-0 grid-rows-[auto_minmax(0,1fr)] overflow-hidden rounded-lg border border-wardian-border bg-[var(--color-wardian-bg)]">
      <ObserveRunHeader
        state={state}
        events={events}
