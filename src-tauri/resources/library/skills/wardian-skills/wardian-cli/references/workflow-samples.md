...
When a user asks to author a workflow, inspect the editable samples in
`<WARDIAN_HOME>/library/workflows/samples/` before proposing a new graph.
...
copy local user workflow content, paths, names, credentials, or destinations
into a new workflow.
