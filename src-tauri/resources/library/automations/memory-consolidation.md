...
nodes:
  ...
  - id: notify
    type: notify
    fields:
      message: Memory consolidation completed. Inspect this automation run for committed revisions and provenance.
edges:
  - from: trigger
    to: consolidate
  - from: consolidate
...
This sample is inert until you run it or bind it to an ordinary automation
