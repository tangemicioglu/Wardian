...
nodes:
  ...
  - id: notify
    type: notify
    fields:
      message: A scheduled brief is ready for operator review in the automation run.
edges:
  - from: trigger
    to: collect
  - from: collect
...
collect-then-publish shape of a local daily automation without including any
