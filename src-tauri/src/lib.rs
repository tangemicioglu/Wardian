...
pub fn run() {
    ...
    let app = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::browser::register_browser_surface_listener,
            commands::browser::release_browser_surface_listener,
            ...
            commands::agent::update_agent_model_selection,
            ...
            commands::debug::debug_grant_file_resource_for_e2e,
            #[cfg(debug_assertions)]
            commands::debug::debug_file_resource_stats,
            ...
            commands::git::git_commit_signed,
            commands::git::git_commit_staged_signed,
            commands::git::git_commit_all_signed,
            commands::git::git_commit_signed_no_verify,
            commands::git::git_commit_staged_signed_no_verify,
            commands::git::git_commit_all_signed_no_verify,
            commands::git::git_rebase_abort,
            commands::git::git_commit_no_verify,
            commands::git::git_commit_staged_no_verify,
            commands::git::git_commit_all_no_verify,
            commands::git::git_commit_empty,
            commands::git::git_commit_empty_no_verify,
            commands::git::git_commit_amend,
            commands::git::git_commit_amend_no_verify,
            commands::git::git_commit_staged_amend_no_verify,
            commands::git::git_commit_all_amend_no_verify,
            commands::git::git_commit_staged_amend,
            commands::git::git_commit_all_amend,
            ...
            commands::git::git_show_stash,
            commands::git::git_stash_staged,
            commands::git::git_stash_apply_latest,
            commands::git::git_stash_apply,
            commands::git::git_stash_pop_latest,
            ...
            commands::library::rename_library_entry,
            commands::library::delete_library_entry,
            commands::library::set_skill_deployments,
